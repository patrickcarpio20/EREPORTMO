...
<div class="myaccordion w-100 py-4 px-1 px-md-4">
	<div class="card">
      ...
      <input type="text" class="form-control" id="name" aria-describedby="basic-addon3" style="border-color: lightgray!important;">
        ...
        <span class="badge badge-info" style="font-size: 12px;color: white;">Processing</span>
        ...
        <?php endif; ?>
	                    	...
	                    	<div class="row">
	                    		<div class="col-md-4">
	                    			<a href="concerninfo.php?id=<?= $row['id']?>">
			...
			<div class="card-footer" style="background-color: white;">
				...
				<div class="text-right noprint">
					<a href="export/concerns.php" target="blank" class="btn btn-success text-white" style="width: 150px;"><i class="fa fa-file-excel-o"></i> Export</a>

					<a href="table-concerns-print.php" target="blank" class="btn btn-info text-white" style="width: 150px;"><i class="fa fa-file-word-o"></i> Print</a>
				</div>
			</div>
		</form>
	</div>
...
function archive(id){
		...
		if (confirm("Achive this Record?")) {
			    ...
			    if (data>0) {
                   ...
                   window.location.href = 'table-concerns.php'; 
			    	}
			    }
