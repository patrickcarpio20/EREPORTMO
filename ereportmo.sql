...
insert  into `tbl_users`(`id`,`fullname`,`username`,`password`,`type`,`status`) values (1,'admin','admin','$2y$10$4EVHCApdcGLEYZ9Z0XEXiep1ZhN.ycXddaxWZ3HPCaJSJwBC8Pngu','admin',1),(2,'Sample','sample','$2y$10$M9P7DEwNZ9cgWrcwgnmkluoSbaZgdv2Q5A1De7ePIpDUSlFKvKpgK','admin',1),(3,'Sample','sample','$2y$10$i0qMV6b/.xU9Bx.EMEqQZOiGvYOm9vYOt0bAXjWhX.h8mKOHIu1VG','admin',1),(5,'Bill Homer','bill','$2y$10$D534.26noSJCbzA26K1bLe7NAyatOTveO5WVujzi8gF8wM8L66hQm','admin',1);
