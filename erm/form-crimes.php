	...
	<form method="POST" id="formcrimes" enctype="multipart/form-data">
		...
		<?php 
			if (isset($_POST['submit'])) {
				...
				if ($description) {
					$query = mysqli_query($conn, "INSERT INTO tbl_crimes (description, crimeinfo, location, name, address, phone, email, created_at) VALUES('$description', '$statement', '$location', '$name', '$address', '$number', '$email', '$curdte') ");
					if ($query) {
						...
						$data = array('type' => '1', 'msg'=>'<div style="color:#fff;">New Crime Report Filed</div>');
						pusher_trigger($pusher, 'crime-channel', 'dashboard-count', $data);
		...
		<div class="card-body text-left" style="padding:0;">
			<div class="col-md-12" style="padding:0;">
				...
				<div class="form-group">
					<div class="col-md-12">
						<label for="statement"><h6>Crime Statement:</h6></label>
						<textarea id="statement" name="statement" type="text" class="form-control" required></textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
