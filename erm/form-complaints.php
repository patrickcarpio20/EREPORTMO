			...
			if (isset($_POST['submit'])) {
				...
				if ($category != "0") {
					...
					if ($query) {
						...
						$data = array('type' => '2', 'msg'=>'<div style="color:#fff;">New Complaint Report filed</div>');
							pusher_trigger($pusher, 'complaint-channel', 'dashboard-count', $data);
	...
	function numonly(e){
		// Allow controls such as backspace, tab etc.
		  ...
		  if(jQuery.inArray(event.which, arr) === -1){
			alertify.alert("E-REPORT MO:","This field accepts numbers only");  
