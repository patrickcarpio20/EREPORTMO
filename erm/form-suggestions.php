			...
			<form method="POST">
				...
				<?php 
					if (isset($_POST['submit'])) {
						...
						$query = mysqli_query($conn, "INSERT INTO tbl_suggestions (description, name, phone, created_at) VALUE ('$description', '$name', '$number', '$curdte') ");
						if ($query) {
							...
							$data = array('type' => '4', 'msg'=>'<div style="color:#fff;">A new suggestion report has been filed</div>');
							pusher_trigger($pusher, 'suggestion-channel', 'dashboard-count', $data);
				...
				<div class="card-body text-left" style="padding:0;">
					<div class="col-md-12" style="padding:0;">
						<label for="description"><h6>Suggestions:</h6></label>
	...
	function numonly(e){
		// Allow controls such as backspace, tab etc.
		  ...
		  if(jQuery.inArray(event.which, arr) === -1){
			alertify.alert("This field accepts numbers only");  
